        ...
        <div className=' flex flex-col md:flex-row relative gap-4  '>
          <div className="div1 flex flex-1 gap-4">
            <div className="flex flex-col flex-1 gap-2 relative">
              ...
              <p>Zengram is a Zen-focused social app designed for mindful connections. Share, reflect, and engage in a peaceful digital space that fosters calmness, positivity, and meaningful interactions.</p>
            ...
            <div className="flex flex-col flex-1 gap-2">
              ...
              <p>EasySportsPass is a smart platform connecting gym owners with corporates, making gym access seamless through easy passes and memberships. Empowering businesses to offer fitness perks while helping gyms grow.</p>
            ...
            <div className="flex flex-col gap-2 relative"> <img src={bluehyphen} alt="" className='object-cover object-left-top h-[24rem]' />
              <p>BlueHyphen is a tech-driven startup building innovative, scalable, and user-centric digital solutions. We turn ideas into seamless web platforms and enterprise applications with creativity and precision.</p>
